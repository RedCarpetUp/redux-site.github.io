...
import { block1, block2, block3, block4 } from "common/data/rocks";
import RocksSection from "../rocks.style";
import RocksContentWrapper from "./rocksContentSection.style";
    ...
    <RocksSection>
      <section>
        <main className="main-content">
          ...
          {/* block 2 */}
          <RocksContentWrapper style={{ background: "#fafbfb" }}>
            <Container>
