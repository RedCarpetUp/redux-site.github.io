...
const CardIssued = ({
  ...
  useEffect(() => {
    let analyticData = {
      ...
      "Screen Name": analyticsData.GIMBOOKS_WAITLIST_SCREEN,
    };
    ...
    <Fragment>
      {isloading ? (
        ...
        <CardTracking
          ...
          redirectUser={redirectUser}
        />
      ) : userStatus == "rejects" && selectedProduct == "redcarpet_gimbooks" ? (
        <CardIssuedWrapper>
        ...
        <CardIssuedWrapper>
          <div className="row-left">
            ...
            <div className="col70">Duplicate Documents</div>
          </div>
          <div class="row">
            <div style={{ margin: "20px 0 0px 0" }}>
              <Image
            ...
            <p className="reject-message">
              You have provided duplicate documents. Please contact support.
            </p>
          </div>
        </CardIssuedWrapper>
      ) : (
        <CardIssuedWrapper>
          ...
          <div class="row">
            ...
            <p style={{ marginBottom: "5%", marginTop: 0 }}>
              You have unlocked the priority access to your GimBooks card. Thank
