...
const GovtDocsRebel = (props) => {
  ...
  useEffect(() => {
    let analyticData = {
      ...
      "Screen Name": analyticsData.REBEL_ONBOARDING_SCREEN,
    };
  ...
  const verifyOtp = async () => {
    try {
      ...
      if (response.result === "success") {
        let analyticData = {
          Event: analyticsData.AADHAR_VERIFICATION_SUCCESS_REBEL,
        };
        useAnalytics(analyticData);
        ...
        let analyticData = {
          Event: analyticsData.AADHAR_VERIFICATION_ERROR_REBEL,
        };
        useAnalytics(analyticData);
        notify({ message: response.message, type: "error" });
      }
  ...
  const setUserPan = async () => {
    ...
    try {
      ...
      if (response.result === "success") {
        setIsLoading(true);
        let response1 = await callApi(
          "/accept_user_agreement_esign_rebel",
          "GET",
          {},
          phone,
          accessToken
  ...
  const SignUser = async () => {
    ...
    try {
      ...
      if (response.result == "success") {
        let analyticData = {
          Event: analyticsData.PAN_VERIFICATION_SUCCESS_REBEL,
        };
        useAnalytics(analyticData);
        try {
          if (dataBranch["~id"]) {
      ...
      <div className="row">
        {isLoading ? (
            ...
            <div className="section-dialog">
              <div className="form Input-line">
                <div className="row-left">
                  ...
                  <div className="col70">
                    <h1 style={{ marginLeft: 5 }}>Rebel Documents</h1>
                  </div>
                </div>
                {otpScreen == "1" ? (
                  <Fragment>
                ...
                {aadharVerified ? (
                  ...
                  <span className={"inputPayCombo-note"}>
                    ...
                    <span className="note-txt">
                      Submitting Pan Card Number for rebel is mandatory for
          ...
          <div className={"col60"}>
            ...
            <Text content="Please download and read the Lender agreement for rebel card below carefully before proceeding." />
            {lender
              ? lender.map((lend) => {
                  return (
                    <div className={"col80"}>
